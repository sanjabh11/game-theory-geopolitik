/*
  # Mental Models Schema Update

  1. New Tables
    - Adds mental_models table with proper structure
    - Adds mental_model_problems for user problem submissions
    - Adds mental_model_solutions for AI-generated solutions
    - Adds mental_model_sessions for user session tracking
    - Adds model_performance_tracking for analytics
    - Adds mental_model_collaborations for team problem-solving

  2. Security
    - Enables RLS on all tables
    - Adds appropriate policies for data access
