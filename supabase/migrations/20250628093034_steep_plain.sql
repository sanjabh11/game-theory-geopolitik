/*
  # Mental Models System Schema

  1. New Tables
    - `mental_models` - Core mental model definitions
    - `mental_model_problems` - User problem submissions
    - `mental_model_solutions` - AI-generated solutions
    - `mental_model_sessions` - User session tracking
    - `model_performance_tracking` - Performance metrics
    - `mental_model_collaborations` - Collaborative problem solving
